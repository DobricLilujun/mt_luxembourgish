...
def create_prompt(
    ...
    full_prompt = (
        ...
        "<|start_header_id|>user<|end_header_id|>\n\n" + f"Translate the English following input text into Luxembourgish. Do not include any additional information or unrelated content.\n\ninput:\n{input_text}"  +  "<|eot_id|><|start_header_id|>assistant<|end_header_id|>" # User Query
    )

    if mode == "train":
        full_prompt += ("\n\nHere is the translation: " + response +"\nEnd of translation."+ eos_token+eos_token+eos_token)
