...
def main(args):
    ...
    INPUT_PATH = args.input_path  # Path to the input data
...
# python scripts/vllm_running_inference.py --model_name Llama-3.2-1B-Instruct --model_path_base /home/snt/llm_models/ --input_path /Users/lujun.li/projects/mt_luxembourgish/data/processed/dic_sentences.jsonl --server_url http://0.0.0.0:8000/v1/chat/completions --is_new_file

# python scripts/vllm_running_inference.py --model_name Llama-3.2-1B-Instruct --model_path_base /home/snt/llm_models/ --input_path /Users/lujun.li/projects/mt_luxembourgish/data/processed/RTL2024_subsentences.jsonl --server_url http://0.0.0.0:8000/v1/chat/completions --is_new_file